 ...
 */
public abstract class OnlineCacheIterator<T extends ReasonerTerm> implements OnlineIterator<T> {
    ...
    public OnlineCacheIterator(
            OnlineTermStore<T> parentStore, boolean readonly,
