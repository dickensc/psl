 ...
 */
public abstract class OnlineInitialRoundIterator<T extends ReasonerTerm> implements OnlineIterator<T> {
    // How much to over-allocate by.
    public static final double OVERALLOCATION_RATIO = 1.25;

    protected OnlineTermStore<T> parentStore;
    ...
    public OnlineInitialRoundIterator(
            OnlineTermStore<T> parentStore, List<WeightedRule> rules,
            AtomManager atomManager, OnlineTermGenerator<T, RandomVariableAtom> termGenerator,
